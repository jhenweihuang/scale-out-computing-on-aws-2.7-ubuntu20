    ...
    def post(self, session_number):
        ...
        try:
            ...
            if [[ "$FS_DATA_PROVIDER" == "efs" ]]; then
                ...
                FSX_DATA_MOUNT_NAME=$($AWS fsx describe-file-systems --file-system-ids $FSX_ID  --query FileSystems[].LustreConfiguration.MountName --outputtext)
            ...
            if [[ "$FS_APPS_PROVIDER" == "efs" ]]; then
                ...
                FSX_APPS_MOUNT_NAME=$($AWS fsx describe-file-systems --file-system-ids $FSX_ID  --query FileSystems[].LustreConfiguration.MountName --outputtext)
